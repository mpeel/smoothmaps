...
for i in range(0,numres):
	...
	smoothnoisemap(directory+'planck2015/', outdirectory, resolution+'smoothed_PlanckR2bpasscorrection_30_MJySrunits', 'LFI_CorrMap_030-BPassCorr_0256_R2.01_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p30,do_intensity=False,do_polarisation=True,units_out=units_out,do_smoothing=False)
	smoothnoisemap(directory+'planck2015/', outdirectory, resolution+'smoothed_PlanckR2bpasscorrection_44_MJySrunits', 'LFI_CorrMap_044-BPassCorr_0256_R2.01_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p44,do_intensity=False,do_polarisation=True,units_out=units_out,do_smoothing=False)
	smoothnoisemap(directory+'planck2015/', outdirectory, resolution+'smoothed_PlanckR2bpasscorrection_70_MJySrunits', 'LFI_CorrMap_070-BPassCorr_0256_R2.01_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p70,do_intensity=False,do_polarisation=True,units_out=units_out,do_smoothing=False)
