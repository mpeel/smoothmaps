...
outdirectory = directory+"planck2020_tqu_noise_v0.8/"
...
for i in range(0,numres):
	...
	# smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR4fullbeam_100_1024_2020_mKCMBunits', 'HFI_SkyMap_100_2048_R4.00_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p100,rescale=rescale,do_intensity=False,do_polarisation=True,units_out=units_out,usehealpixfits=True)
	# smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR4fullbeam_143_1024_2020_mKCMBunits', 'HFI_SkyMap_143_2048_R4.00_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p143,rescale=rescale,do_intensity=True,do_polarisation=True,units_out=units_out,usehealpixfits=True)
	# smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR4fullbeam_217_1024_2020_mKCMBunits', 'HFI_SkyMap_217_2048_R4.00_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p217,rescale=rescale,do_intensity=True,do_polarisation=True,units_out=units_out,usehealpixfits=True)
	smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR4fullbeam_353_1024_2020_mKCMBunits', 'HFI_SkyMap_353_2048_R4.00_full.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p353,rescale=rescale,do_intensity=True,do_polarisation=True,units_out=units_out,usehealpixfits=True)

	# Intensity only for 545 and 857GHz
	smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR3fullbeam_545_1024_2020_MJySrunits', 'HFI_SkyMap_545_2048_R4.00_full.fits',mapnumber=2,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p545,do_intensity=True,do_polarisation=False,units_out='MJySr',usehealpixfits=True)
	smoothnoisemap(directory+'planck2020/', outdirectory, resolution+'smoothed_PlanckR3fullbeam_857_1024_2020_MJySrunits', 'HFI_SkyMap_857_2048_R4.00_full.fits',mapnumber=2,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=beamtf_p857,do_intensity=True,do_polarisation=False,units_out='MJySr',usehealpixfits=True)
