...
# smoothmap(directory,directory,'quijote_11GHz_horn3_0001_sm1deg.fits','quijote_11GHz_horn3_0001_sm1deg_checksmth2.fits', 0.0,windowfunction=wfq[2][0],nside_out=512,units_in='mKCMB',units_out='mKCMB',use_precomputed_wf=True,do_pol_combined=True,useunseen=False)
# exit()
...
plt.clf()
infile2 = directory+'quijote_11GHz_horn3_0001_sm1deg_checksmth2.fits'
