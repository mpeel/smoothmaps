...
for i in range(0,numres):
	...
	smoothnoisemap(directory, outdirectory, resolution+'smoothed_QUIJOTEMFI1_11.0_2021_mKCMBunits.fits', 'mfi_mar2021_11.0_1.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=wfq[0][0],rescale=rescale,do_intensity=True,do_polarisation=True,units_out=units_out)
	smoothnoisemap(directory, outdirectory, resolution+'smoothed_QUIJOTEMFI1_13.0_2021_mKCMBunits.fits', 'mfi_mar2021_31.0_1.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],nside=output_nside,windowfunction=wfq[0][1],rescale=rescale,do_intensity=True,do_polarisation=True,units_out=units_out)
