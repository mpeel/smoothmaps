...
if doing_quijote:
	...
	if planckver == '2015':
		indirectory = '/Users/mpeel/Documents/maps/wmap9_planck2015_tqu_v1.4/'
		outdirectory = indirectory
		prefix='wmap9_planck2018_tqu_1.4'
		nside = 256
		maps = ['256_60.0smoothed_PlanckR2fullbeambpcorr_28.4_256_2015_mKCMBunits.fits','256_60.0smoothed_PlanckR2fullbeambpcorr_44.1_256_2015_mKCMBunits.fits','512_60.0smoothed_wmap9beam_22.8_512_20132015_mKCMBunits.fits','512_60.0smoothed_wmap9beam_33.0_512_20132015_mKCMBunits.fits','512_60.0smoothed_wmap9beam_40.7_512_20132015_mKCMBunits.fits']
		varianceindex=[[3,4,5], [3,4,5], [3,3,3], [3,3,3], [3,3,3]]
	elif planckver == '2018':
		indirectory = '/Users/mpeel/Documents/maps/wmap9_planck2018_tqu_v1.4/'
		outdirectory = indirectory
		prefix='wmap9_planck2018_tqu_1.4'
		...
		varianceindex=[[4,7,9], [4,7,9], [3,3,3], [3,3,3], [3,3,3]]
	elif planckver == '2018dec':
		indirectory = '/Users/mpeel/Documents/maps/wmap9_planck2018_tqu_v1.4/'
		outdirectory = indirectory
		prefix='wmap9_planck2018dec_tqu_1.4'
		maps = ['512_60.0smoothed_PlanckR3dec40_28.4_1024_2018_mKCMBunits.fits','512_60.0smoothed_PlanckR3dec30_44.1_1024_2018_mKCMBunits.fits','512_60.0smoothed_wmap9beam_22.8_512_20132018_mKCMBunits.fits','512_60.0smoothed_wmap9beam_33.0_512_20132018_mKCMBunits.fits','512_60.0smoothed_wmap9beam_40.7_512_20132018_mKCMBunits.fits']
		varianceindex=[[4,7,9], [4,7,9], [3,3,3], [3,3,3], [3,3,3]]
		separate_variance_maps = ['512_60.0smoothed_PlanckR3fullbeam_28.4_1024_2018_mKCMBunits.fits','512_60.0smoothed_PlanckR3fullbeam_44.1_1024_2018_mKCMBunits.fits']
	elif planckver == '2020':
		indirectory = '/Users/mpeel/Documents/maps/wmap9_planck2020_tqu_v1.4/'
		outdirectory = indirectory
		prefix='wmap9_planck2020_tqu_1.4'
		maps = ['512_60.0smoothed_PlanckR4fullbeam_28.4_1024_2020_mKCMBunits.fits','512_60.0smoothed_PlanckR4fullbeam_44.1_1024_2020_mKCMBunits.fits','../wmap9_planck2018_tqu_v1.4/512_60.0smoothed_wmap9beam_22.8_512_20132018_mKCMBunits.fits','../wmap9_planck2018_tqu_v1.4/512_60.0smoothed_wmap9beam_33.0_512_20132018_mKCMBunits.fits','../wmap9_planck2018_tqu_v1.4/512_60.0smoothed_wmap9beam_40.7_512_20132018_mKCMBunits.fits']
		varianceindex=[[4,7,9], [4,7,9], [3,3,3], [3,3,3], [3,3,3]]
	...
	if only_wmap:
		...
		rescale_variance[0] *= (1.435/1.429)**2
		rescale_variance[1] *= (1.472/1.466)**2
		rescale_variance[2] *= (2.197/2.188)**2
		varianceindex=[[3,3,3], [3,3,3], [3,3,3]]
